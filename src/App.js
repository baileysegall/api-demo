...
function App() {
  ...
  function moreInfo(doggo) {
    ...
    if (doggo[0].breeds[0]) {
      ...
      return <div class="text">{doggo[0].breeds[0].name}</div>;
    } else {
      //if the table doesn't exist.. display no information
      return <div class="text">No Information</div>;
    }
  }
  ...
  if (doggo === null) {
    return (
      <div class="main">
        ...
        <button onClick={getDogWithAxios} class="button">
          Gimme Doggies
        </button>
      </div>
    );
  ...
  //if the doggo is updated render the image and the hover component
    ...
    return (
      <div class="main">
        ...
        <button onClick={getDogWithAxios} class="button-with-image">
          Gimme Doggies
        </button>
      </div>
    );
